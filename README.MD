...
6. Open the config.ini 1.0.3 and copy the section [iqey-setup] into the new `/config/config.ini` 1.0.4
7. Set the correct values to the properties in the section [aek-setup] 
